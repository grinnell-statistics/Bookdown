...
anova_tab <- data.frame(
  Assumption = c("Normality", "Zero mean", "Equal variances","Independence", "Identically distributed"),
  Plot = c("Histogram or normal probability plot", "No plot (errors will always sum to zero under these models)", "Plot of the residuals versus fits and each explanatory variable", "Residuals versus order", "No plot (ensure each subject was sampled from the same population within each group)"),
