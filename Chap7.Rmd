...
```{r fig7.1, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Picture of the space shuttle Challenger just after ignition. Each solid rocket booster had six O-rings, two at each field joint. The O-rings at the right aft field joint failed."}
...
```{r fig7.2, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Diargam of a solid rocket booster."}
...
```{r fig7.3, warning=FALSE, echo=FALSE, fig.width=6, fig.height=4, message=FALSE, fig.cap="Figure 7.3 Space shuttle data with a simple linear regression model and a logistic regression model."}
...
```{r fig7.5, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Minitab output for the space shuttle study."}
...
```{r fig7.8, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Minitab output showing measures of association for the space shuttle data."}
...
```{r fig7.10, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Minitab output for the Cancercells study"}
