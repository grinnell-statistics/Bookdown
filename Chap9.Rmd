...
```{r fig9.1, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Kaplan-Meier estimated proportions (estimated survival probabilities) of chocolate chips."}
...
```{r fig9.2, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Kaplan-Meier survival curves for different chip melting experiences."}
...
```{r fig9.3, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Kaplan-Meier estimated proportions. Vertical lines appear at the complete melting times, and grid marks are overlaid on the graph. The dimension of each square in the grid is 5 seconds (width) by 0.1 (height)."}
...
```{r fig9.4, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Kaplan-Meier estimated proportions. The horizontal dotted line represents $\\hat S(55)_{\\mathrm{KM}} = 0.3$ and the vertical dotted line represents $\\hat t_{(70)} = t_4 = 55$."}
...
```{r fig9.5, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Kaplan-Meier curve with 95% confidence intervals. Note that Minitab graphs use the same line type and color for both the Kaplan-Meier curve and the confidence limits; however, the middle line will always be the Kaplan-Meier curve."}
...
```{r fig9.6, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Kaplan-Meier curves for the hypothetical melting times of milk and white chocolate chips."}
...
```{r fig9.7, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Software output for the log-rank and Wilcoxon tests."}
...
```{r fig9.8, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Possible forms of the population hazard function."}
...
```{r fig9.9, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Estimated survival probabilities and estimated hazard rates for the chocolate chip data."}
...
```{r fig9.10, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Estimated survival probabilities and estimated hazard rates for the age at first drink data."}
...
```{r fig9.11, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Estimated survival probabilities and estimated hazard rates for the time until the motorist displays aggressive behavior."}
...
```{r fig9.12, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Cumulative hazard function displaying various rates of change over time"}
...
```{r fig9.13, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Population hazard functions and their corresponding cumulative hazard functions."}
...
```{r fig9.14, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Estimated hazard function and estimated cumulative hazard function for the chip melting data."}
...
```{r fig9.15, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Estimated hazard function and estimated cumulative hazard function for the aggressive motorist behavior."}
...
```{r fig9.16, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Observed survival times for four subjects. X indicates the target event occurred at displayed time; O indicates the target event was not observed (event time is censored); < indicates when Subject 2 was first observed in the study."}
...
```{r fig9.17, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Kaplan-Meier curve for survival times after brain cancer diagnosis."}
...
```{r fig9.18, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Kaplan-Meier curves for AML relapse times for patients who did and did not receive maintenance chemotherapy."}
...
```{r fig9.19, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Population cumulative hazard functions for three distributions of $T$"}
